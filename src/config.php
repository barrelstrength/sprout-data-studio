...
/**
 * Sprout Data Studio config.php
 *
 * This file exists only as a template for the Sprout Data Studio settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'sprout-data-studio.php'
...
return [
    ...
    'pluginNameOverride' => 'Sprout Data Studio',
